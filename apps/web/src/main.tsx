  ...
  return (
    <>
      ...
      <nav>
        ...
        <a href="#verticals" className="nav-cta">Get Access</a>
      </nav>
      ...
      <section className="hero">
        ...
        <div className="hero-actions">
          <a href="#verticals" className="btn-primary">Explore Verticals</a>
      ...
      <section className="cta-section" id="contact">
        ...
        <div className="cta-actions">
          <a href="#verticals" className="btn-primary">Start Building</a>
